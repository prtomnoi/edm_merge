                ...
                <div class="card w-100">
                    <div class="card-body p-4">
                        ...
                        <div class="alert alert-success alert-dismissible fade show my-2" role="alert">
                         ...
                         @endif
                        <a href="{{ route('influencer-video.create') }}" class="btn btn-primary mb-3"> <i class="ti ti-plus"></i> Add
                            data</a>
                                    ...
                                    @foreach(@$influencerVideo as $key=>$item)
                                      <tr>
                                          ...
                                          <td class="text-center" style="width:10%;">
                                              <a href="{{route("influencer-video.edit",$item->id)}}" class="btn btn-warning"><i class="ti ti-pencil"></i> Edit</a>
