            ...
            <div class="col-lg-12 d-flex align-items-stretch">
                ...
                <div class="card w-100">
                    <div class="card-body p-4">
                        <h5 class="card-title fw-semibold mb-4">VTuber Video</h5>
                        @if(session('success'))
                        <div class="alert alert-success alert-dismissible fade show my-2" role="alert">
                         ...
                         @endif
                        <a href="{{ route('vtuber-video.create') }}" class="btn btn-primary mb-3"> <i class="ti ti-plus"></i> Add
                            data</a>
                            ...
                            <table class="table text-nowrap mb-0 align-middle" id="myTable">
                                <thead class="text-dark fs-4">
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0">Video</h6>
                                        </th>
                                        <th class="border-bottom-0">
                                    ...
                                    @foreach(@$data as $key=>$item)
                                      <tr>
                                          ...
                                          <td class="text-center" style="width:10%;">
                                              <a href="{{route("vtuber-video.edit",$item->id)}}" class="btn btn-warning"><i class="ti ti-pencil"></i> Edit</a>
