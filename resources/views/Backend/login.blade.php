...
<head>
    ...
    <title>EDM Company</title>
    <link rel="shortcut icon" type="image/png" href="{{ URL::asset('backend/assets/images/logos/logo-edm.png') }}" />
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="#" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                    <img src="backend/assets/images/logos/logo-edm2.png" width="180" alt="">
                                </a>
