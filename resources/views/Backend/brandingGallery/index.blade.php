                ...
                <div class="card w-100">
                    <div class="card-body p-4">
                        ...
                        <div class="alert alert-success alert-dismissible fade show my-2" role="alert">
                         ...
                         @endif
                        <a href="{{ route('branding-gallery.create') }}" class="btn btn-primary mb-3"> <i class="ti ti-plus"></i> Add
                            data</a>
                                ...
                                <tbody>
                                    ...
                                    @foreach(@$brandingGallery as $key=>$item)
                                      <tr>
                                          ...
                                          <td style="width:10%;"><a href="{{asset('backend/' . $item->image)}}" target="_blank"><img src="{{asset('backend/' . $item->image)}}" alt="" style="width:150px;"></a></td>
