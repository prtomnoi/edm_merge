                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('news.update',$news->id) }}" method="POST" enctype="multipart/form-data">
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <select name="news_category" class="form-control">
                                        @foreach ($categorys as $category)
                                            <option value="{{ $category->id }}" @if($category->id == $news->news_category) selected @endif>{{ $category->name }}</option>
                                         @endforeach
                                  </select>
                                 </div>
                              </div>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="title_en" placeholder="Title" value="{{@$news->title_en}}">
                            </div>
                            <div class="form-group mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                   <div class="form-group mb-2">
                                       ...
                                       <input type="text" class="form-control" name="signature" placeholder="" value="{{@$news->signature}}">
                                       </div>
                                </div>
                                <div class="col-md-6">
