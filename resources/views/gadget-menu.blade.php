...
<div class="gadget-menu" id="gadget-menu">
    <a href="#" id="facebook"><img src="{{asset('assets/img/gadget-icons/fb-icon.svg')}}" alt="" /></a>
    <a href="#" id="youtube"><img src="{{asset('assets/img/gadget-icons/yt-icon.svg')}}" alt="" /></a>
    <a href="#" id="url"><img src="{{asset('assets/img/gadget-icons/gadget-edm-icon.svg')}}" alt="" /></a>
    {{-- <a href="#" id="contact"><img src="{{asset('assets/img/gadget-icons/joinus-icon.svg')}}" alt="" /></a> --}}
</div>
{{-- @endif --}}
